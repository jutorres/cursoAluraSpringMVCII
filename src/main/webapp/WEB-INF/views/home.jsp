	...
	<section id="index-section" class="container middle">
		...
		<ul id="cdc-diferenciais" class="clearfix">
			<li class="col-left">
				...
				<p><span class="sprite" id="sprite-drm"></span> 
			...
			<li class="col-right">
				...
				<p><span class="sprite" id="sprite-renome"></span> 
			...
			<li class="col-left">
				...
				<p><span class="sprite" id="sprite-atualizacoes"></span> 
			...
			<li class="col-right">
				...
				<p><span class="sprite" id="sprite-caelum"></span> 
